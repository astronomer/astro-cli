...
var (
	...
	WARNING_INVALID_IMAGE_TAG   = "WARNING! You are going to push an image using the '%s' tag. This is not recommended. Please base your image off to one of valid image tags: %s. Are you sure you want to continue?\n"
)
