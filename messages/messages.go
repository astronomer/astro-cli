...
var (
	...
	ASTROHUB_BASIC_AUTH_DISABLED      = "Basic authentication is disabled, conact administrator or defer back to oAuth"
	ASTROHUB_CURRENT_VERSION          = "Astro Server Version: %s"
	ASTROHUB_DEPLOYMENT_HEADER        = "Authenticated to %s \n\n"
	ASTROHUB_DEPLOYING_PROMPT         = "Deploying: %s\n"
	ASTROHUB_NO_DEPLOYMENTS_ERROR     = "No airflow deployments found"
	ASTROHUB_DEPLOYMENT_NAME_ERROR    = "Please specify a valid deployment name"
	ASTROHUB_SELECT_DEPLOYMENT_PROMPT = "Select which airflow deployment you want to deploy to:"
	ASTROHUB_OAUTH_REDIRECT           = "Please visit the following URL, authenticate and paste token in next prompt\n"
	ASTROHUB_INVALID_DEPLOYMENT_KEY   = "Invalid deployment selection\n"
