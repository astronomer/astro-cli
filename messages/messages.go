...
var (
	...
	ErrComposeCreate      = "Error creating docker-compose project"
	ErrComposeStatusCheck = "Error checking docker-compose status"
	ErrComposeStop        = "Error stopping and removing containers"
	ErrComposePause       = "Error pausing project containers"
	ErrComposeRecreate    = "Error building, (re)creating or starting project containers"

	ComposeImageBuildingPrompt = "Building image..."
	ComposePushingImagePrompt  = "Pushing image to Astronomer registry"
	ComposeLinkWebserver       = "Airflow Webserver: http://localhost:%s"
	ComposeLinkPostgres        = "Postgres Database: localhost:%s/postgres"
	ComposeUserPassword        = "The default credentials are admin:admin"
