...
func TestLogin(t *testing.T) {
	...
	cloudLogin = func(domain string, client astro.Client, out io.Writer, shouldDisplayLoginLink, shouldLoginWithToken bool) error {
		assert.Equal(t, cloudDomain, domain)
		return nil
	}

	softwareLogin = func(domain string, oAuthOnly bool, username, password string, interactive bool, pageSize int, client houston.ClientInterface, out io.Writer) error {
