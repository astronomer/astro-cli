...
func TestWorkspacUserUpdate(t *testing.T) {
	expectedHelp := "astro workspace user update [email] --role [WORKSPACE_MEMBER, WORKSPACE_BILLING_ADMIN, WORKSPACE_OWNER]"
	testUtil.InitTestConfig(testUtil.CloudPlatform)
...
func TestWorkspaceUserAdd(t *testing.T) {
	expectedHelp := "astro workspace user add [email] --role [WORKSPACE_MEMBER, WORKSPACE_BILLING_ADMIN, WORKSPACE_OWNER]"
	testUtil.InitTestConfig(testUtil.CloudPlatform)
