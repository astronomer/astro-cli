...
func TestAirflowUpgradeTest(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		mockContainerHandler := new(mocks.ContainerHandler)
		containerHandlerInit = func(airflowHome, envFile, dockerfile, imageName string) (airflow.ContainerHandler, error) {
			mockContainerHandler.On("UpgradeTest", mock.Anything, mock.Anything, mock.Anything, false, false, false, nil).Return(nil).Once()
			return mockContainerHandler, nil
		}
	...
	t.Run("failure", func(t *testing.T) {
		...
		mockContainerHandler := new(mocks.ContainerHandler)
		containerHandlerInit = func(airflowHome, envFile, dockerfile, imageName string) (airflow.ContainerHandler, error) {
			mockContainerHandler.On("UpgradeTest", mock.Anything, mock.Anything, mock.Anything, false, false, false, nil).Return(errMock).Once()
			return mockContainerHandler, nil
		}
