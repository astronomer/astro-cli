...
core_api_gen:
	...
	oapi-codegen -include-tags=User,Organization,Invite,Workspace,Cluster,Options,ApiToken -generate=types,client -package=astrocore "${CORE_OPENAPI_SPEC}" > ./astro-client-core/api.gen.go
