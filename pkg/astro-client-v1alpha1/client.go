...
// errRequest is returned when a v1alpha1 API call fails without a decodable error body.
...
// NormalizeAPIError converts a non-success v1alpha1 API response into an error,
