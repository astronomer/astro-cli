...
// AzureClientAPI is an autogenerated mock type for the AzureClientAPI type
type AzureClientAPI struct {
	mock.Mock
}

// NewBlockBlobClientWithNoCredential provides a mock function with given fields: blobURL, options
func (_m *AzureClientAPI) NewBlockBlobClientWithNoCredential(blobURL string, options *azblob.ClientOptions) (*azblob.BlockBlobClient, error) {
...
func (_m *AzureClientAPI) UploadStream(ctx context.Context, body io.Reader, o *azblob.UploadStreamOptions) (*azblob.BlockBlobCommitBlockListResponse, error) {
...
type mockConstructorTestingTNewAzureClientAPI interface {
	mock.TestingT
	Cleanup(func())
}

// NewAzureClientAPI creates a new instance of AzureClientAPI. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewAzureClientAPI(t mockConstructorTestingTNewAzureClientAPI) *AzureClientAPI {
	mock := &AzureClientAPI{}
	mock.Mock.Test(t)
