...
require (
	...
	github.com/docker/docker v17.12.0-ce-rc1.0.20190327083406-200b524eff60+incompatible
...
replace github.com/containerd/containerd => github.com/containerd/containerd v1.2.7

replace github.com/docker/docker => github.com/docker/docker v17.12.0-ce-rc1.0.20190327083406-200b524eff60+incompatible

replace golang.org/x/crypto v0.0.0-20190129210102-0709b304e793 => golang.org/x/crypto v0.0.0-20180904163835-0709b304e793

replace vbom.ml/util/sortorder v1.0.2 => github.com/fvbommel/sortorder v1.0.2
