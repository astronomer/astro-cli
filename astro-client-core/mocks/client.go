...
func (_m *ClientWithResponsesInterface) CreateOrganizationWithResponse(ctx context.Context, body astrocore.MutateOrganizationRequest, reqEditors ...astrocore.RequestEditorFn) (*astrocore.CreateOrganizationResponse, error) {
	...
	var r0 *astrocore.CreateOrganizationResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, astrocore.MutateOrganizationRequest, ...astrocore.RequestEditorFn) (*astrocore.CreateOrganizationResponse, error)); ok {
...
// GetClusterWithResponse provides a mock function with given fields: ctx, orgShortNameId, clusterId, params, reqEditors
func (_m *ClientWithResponsesInterface) GetClusterWithResponse(ctx context.Context, orgShortNameId string, clusterId string, params *astrocore.GetClusterParams, reqEditors ...astrocore.RequestEditorFn) (*astrocore.GetClusterResponse, error) {
	_va := make([]interface{}, len(reqEditors))
	for _i := range reqEditors {
		_va[_i] = reqEditors[_i]
	}
	var _ca []interface{}
	_ca = append(_ca, ctx, orgShortNameId, clusterId, params)
	_ca = append(_ca, _va...)
	ret := _m.Called(_ca...)

	var r0 *astrocore.GetClusterResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, *astrocore.GetClusterParams, ...astrocore.RequestEditorFn) (*astrocore.GetClusterResponse, error)); ok {
		return rf(ctx, orgShortNameId, clusterId, params, reqEditors...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, *astrocore.GetClusterParams, ...astrocore.RequestEditorFn) *astrocore.GetClusterResponse); ok {
		r0 = rf(ctx, orgShortNameId, clusterId, params, reqEditors...)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, *astrocore.GetClusterParams, ...astrocore.RequestEditorFn) error); ok {
		r1 = rf(ctx, orgShortNameId, clusterId, params, reqEditors...)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *ClientWithResponsesInterface) UpdateOrganizationWithResponse(ctx context.Context, orgShortNameId string, body astrocore.MutateOrganizationRequest, reqEditors ...astrocore.RequestEditorFn) (*astrocore.UpdateOrganizationResponse, error) {
	...
	var r0 *astrocore.UpdateOrganizationResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, astrocore.MutateOrganizationRequest, ...astrocore.RequestEditorFn) (*astrocore.UpdateOrganizationResponse, error)); ok {
		return rf(ctx, orgShortNameId, body, reqEditors...)
	}
