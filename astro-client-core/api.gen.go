...
type Cluster struct {
	...
	OrganizationProductTier *string              `json:"organizationProductTier,omitempty"`
...
type GetClusterParams struct {
	// IncludeNodePools include node pools
	IncludeNodePools *bool `form:"includeNodePools,omitempty" json:"includeNodePools,omitempty"`

	// IncludeCreatedUpdatedBy include created by and updated by information
	IncludeCreatedUpdatedBy *bool `form:"includeCreatedUpdatedBy,omitempty" json:"includeCreatedUpdatedBy,omitempty"`

	// IncludeWorkspaceIds include mapped workspace IDs
	IncludeWorkspaceIds *bool `form:"includeWorkspaceIds,omitempty" json:"includeWorkspaceIds,omitempty"`
}
...
type ClientInterface interface {
	...
	// GetCluster request
	GetCluster(ctx context.Context, orgShortNameId string, clusterId string, params *GetClusterParams, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) GetCluster(ctx context.Context, orgShortNameId string, clusterId string, params *GetClusterParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetClusterRequest(c.Server, orgShortNameId, clusterId, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewGetClusterRequest(server string, orgShortNameId string, clusterId string, params *GetClusterParams) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/organizations/%s/cluster/%s", pathParam0, pathParam1)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
	...
	if params.IncludeNodePools != nil {

		if queryFrag, err := runtime.StyleParamWithLocation("form", true, "includeNodePools", runtime.ParamLocationQuery, *params.IncludeNodePools); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
	...
	if params.IncludeCreatedUpdatedBy != nil {

		if queryFrag, err := runtime.StyleParamWithLocation("form", true, "includeCreatedUpdatedBy", runtime.ParamLocationQuery, *params.IncludeCreatedUpdatedBy); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
	...
	if params.IncludeWorkspaceIds != nil {

		if queryFrag, err := runtime.StyleParamWithLocation("form", true, "includeWorkspaceIds", runtime.ParamLocationQuery, *params.IncludeWorkspaceIds); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
...
func NewGetSharedClusterRequest(server string, params *GetSharedClusterParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/v1alpha1/clusters/shared")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// GetCluster request
	GetClusterWithResponse(ctx context.Context, orgShortNameId string, clusterId string, params *GetClusterParams, reqEditors ...RequestEditorFn) (*GetClusterResponse, error)
...
func (c *ClientWithResponses) GetClusterWithResponse(ctx context.Context, orgShortNameId string, clusterId string, params *GetClusterParams, reqEditors ...RequestEditorFn) (*GetClusterResponse, error) {
	rsp, err := c.GetCluster(ctx, orgShortNameId, clusterId, params, reqEditors...)
	if err != nil {
		return nil, err
	}
