...
const (
	OrganizationPaymentMethodAWSMARKETPLACE OrganizationPaymentMethod = "AWS_MARKETPLACE"

	OrganizationPaymentMethodAZUREMARKETPLACE OrganizationPaymentMethod = "AZURE_MARKETPLACE"

	OrganizationPaymentMethodCREDITCARD OrganizationPaymentMethod = "CREDIT_CARD"

	OrganizationPaymentMethodGCPMARKETPLACE OrganizationPaymentMethod = "GCP_MARKETPLACE"

	OrganizationPaymentMethodINVOICE OrganizationPaymentMethod = "INVOICE"
)
...
const (
	PaymentMethodCardWalletTypeAmexExpressCheckout PaymentMethodCardWalletType = "amexExpressCheckout"

	PaymentMethodCardWalletTypeApplePay PaymentMethodCardWalletType = "applePay"

	PaymentMethodCardWalletTypeGooglePay PaymentMethodCardWalletType = "googlePay"
	...
	PaymentMethodCardWalletTypeSamsungPay PaymentMethodCardWalletType = "samsungPay"

	PaymentMethodCardWalletTypeVisaCheckout PaymentMethodCardWalletType = "visaCheckout"
)
...
type CreateOrganizationRequest struct {
	Metadata *CreateOrganizationRequest_Metadata `json:"metadata,omitempty"`
	Name     string                              `json:"name"`
}

// CreateOrganizationRequest_Metadata defines model for CreateOrganizationRequest.Metadata.
type CreateOrganizationRequest_Metadata struct {
...
type DagFilters struct {
	Deployments DagFilters_Deployments `json:"deployments"`
	Owners      []string               `json:"owners"`
	Tags        []string               `json:"tags"`
	Warnings    *[]string              `json:"warnings,omitempty"`
}

// DagFilters_Deployments defines model for DagFilters.Deployments.
type DagFilters_Deployments struct {
...
type InvoiceLineItem struct {
	...
	CustomFields InvoiceLineItem_CustomFields `json:"customFields"`
...
// InvoiceLineItem_CustomFields defines model for InvoiceLineItem.CustomFields.
type InvoiceLineItem_CustomFields struct {
	AdditionalProperties map[string]string `json:"-"`
}
...
type InvoiceSubLineItem struct {
	...
	CustomFields InvoiceSubLineItem_CustomFields `json:"customFields"`
	Name         string                          `json:"name"`
...
// InvoiceSubLineItem_CustomFields defines model for InvoiceSubLineItem.CustomFields.
type InvoiceSubLineItem_CustomFields struct {
	AdditionalProperties map[string]string `json:"-"`
}
...
type PaymentMethod struct {
	...
	Id             string                       `json:"id"`
	Metadata       *PaymentMethod_Metadata      `json:"metadata,omitempty"`
	Type           string                       `json:"type"`
	UsBankAccount  *PaymentMethodUSBankAccount  `json:"usBankAccount,omitempty"`
}

// PaymentMethod_Metadata defines model for PaymentMethod.Metadata.
type PaymentMethod_Metadata struct {
	AdditionalProperties map[string]string `json:"-"`
}
...
type TaskInstance struct {
	...
	RenderedFields *TaskInstance_RenderedFields `json:"renderedFields,omitempty"`
	StartDate      *string                      `json:"startDate,omitempty"`
...
// TaskInstance_RenderedFields defines model for TaskInstance.RenderedFields.
type TaskInstance_RenderedFields struct {
	AdditionalProperties map[string]interface{} `json:"-"`
}
...
type UpdateOrganizationRequest struct {
	BillingEmail  *string                             `json:"billingEmail,omitempty"`
	IsScimEnabled bool                                `json:"isScimEnabled"`
	Metadata      *UpdateOrganizationRequest_Metadata `json:"metadata,omitempty"`
	Name          string                              `json:"name"`
}

// UpdateOrganizationRequest_Metadata defines model for UpdateOrganizationRequest.Metadata.
type UpdateOrganizationRequest_Metadata struct {
	AdditionalProperties map[string]interface{} `json:"-"`
}
...
type InternalMappedTaskInstanceSummary struct {
	...
	StartDate    *string                                   `json:"startDate,omitempty"`
	States       *InternalMappedTaskInstanceSummary_States `json:"states,omitempty"`
	TaskId       *string                                   `json:"taskId,omitempty"`
	TryNumber    *int                                      `json:"tryNumber,omitempty"`
}

// InternalMappedTaskInstanceSummary_States defines model for InternalMappedTaskInstanceSummary.States.
type InternalMappedTaskInstanceSummary_States struct {
	AdditionalProperties map[string]int `json:"-"`
}

// InternalOutlet defines model for internal_Outlet.
type InternalOutlet struct {
	Extra *InternalOutlet_Extra `json:"extra,omitempty"`
	Type  *string               `json:"type,omitempty"`
	Uri   *string               `json:"uri,omitempty"`
}

// InternalOutlet_Extra defines model for InternalOutlet.Extra.
type InternalOutlet_Extra struct {
	AdditionalProperties map[string]string `json:"-"`
}
...
type GetSharedClusterParams struct {
	...
	// cloud provider
	CloudProvider GetSharedClusterParamsCloudProvider `json:"cloudProvider"`
}
...
type GetClusterOptionsParams struct {
	// cloud provider
	Provider *GetClusterOptionsParamsProvider `json:"provider,omitempty"`

	// cluster type
	Type GetClusterOptionsParamsType `json:"type"`
}
...
type ListOrganizationsParams struct {
	...
	Product *ListOrganizationsParamsProduct `json:"product,omitempty"`

	// sorting criteria, each criterion should conform to format 'fieldName:asc' or 'fieldName:desc'
	Sorts *[]ListOrganizationsParamsSorts `json:"sorts,omitempty"`
}
...
type CreateOrganizationJSONBody CreateOrganizationRequest
...
type UpdateOrganizationJSONBody UpdateOrganizationRequest
...
type ListClustersParams struct {
	// cloud provider to filter clusters on
	Provider *ListClustersParamsProvider `json:"provider,omitempty"`

	// type to filter clusters on
	Type *[]ListClustersParamsType `json:"type,omitempty"`

	// status to filter clusters on
	Status *ListClustersParamsStatus `json:"status,omitempty"`

	// string to search for when listing clusters
	Search *string `json:"search,omitempty"`
	...
	// sorting criteria, each criterion should conform to format 'fieldName:asc' or 'fieldName:desc'
	Sorts *[]ListClustersParamsSorts `json:"sorts,omitempty"`
}
...
// CreateAwsClusterJSONBody defines parameters for CreateAwsCluster.
type CreateAwsClusterJSONBody CreateAwsClusterRequest

// UpdateAwsClusterJSONBody defines parameters for UpdateAwsCluster.
type UpdateAwsClusterJSONBody UpdateAwsClusterRequest

// CreateAzureClusterJSONBody defines parameters for CreateAzureCluster.
type CreateAzureClusterJSONBody CreateAzureClusterRequest

// UpdateAzureClusterJSONBody defines parameters for UpdateAzureCluster.
type UpdateAzureClusterJSONBody UpdateAzureClusterRequest

// CreateGcpClusterJSONBody defines parameters for CreateGcpCluster.
type CreateGcpClusterJSONBody CreateGcpClusterRequest

// UpdateGcpClusterJSONBody defines parameters for UpdateGcpCluster.
type UpdateGcpClusterJSONBody UpdateGcpClusterRequest

// ListDeploymentsParams defines parameters for ListDeployments.
type ListDeploymentsParams struct {
	// Ids that define the deployments
	DeploymentIds *[]string `json:"deploymentIds,omitempty"`

	// Ids that define the workspaces where deployments belong to
...
type GetDeploymentDagRunsParams struct {
	// page size, default of 20
	PageSize *int `json:"pageSize,omitempty"`

	// pagination cursor
	Cursor *string `json:"cursor,omitempty"`

	// filter by ID of the dags run
	RunId *string `json:"runId,omitempty"`

	// filter by logical date (aka execution date)  of  the  dags  run  less     than  (RFC3339 format)
	LogicalDateLt *time.Time `json:"logicalDate__lt,omitempty"`

	// filter by logical date (aka execution date)  of  the  dags  run  greater  than  (RFC3339 format)
	LogicalDateGt *time.Time `json:"logicalDate__gt,omitempty"`

	// filter by start date of the dags run less than (RFC3339 format)
	StartDateLt *time.Time `json:"startDate__lt,omitempty"`

	// filter by start date of the dags run greater than (RFC3339 format)
	StartDateGt *time.Time `json:"startDate__gt,omitempty"`

	// filter by end date of the dags run less than (RFC3339 format)
	EndDateLt *time.Time `json:"endDate__lt,omitempty"`

	// filter by end date of the dags run greater than (RFC3339 format)
	EndDateGt *time.Time `json:"endDate__gt,omitempty"`

	// filter by dags runs with any of these run states
	State *[]GetDeploymentDagRunsParamsState `json:"state,omitempty"`

	// filter by dags runs with any of these run types
	RunTypeIn *[]GetDeploymentDagRunsParamsRunTypeIn `json:"runType__in,omitempty"`
}
...
type GetDeploymentLogsParams struct {
	// log sources to select logs from
	Sources []GetDeploymentLogsParamsSources `json:"sources"`

	// limit of the count of the logs
	Limit *int `json:"limit,omitempty"`

	// offset of the log entries
	Offset *int `json:"offset,omitempty"`

	// range of the log search in seconds
	Range *int `json:"range,omitempty"`

	// maximum number of results across all pages
	MaxNumResults *int `json:"maxNumResults,omitempty"`

	// searchId to get logs from
	SearchId *string `json:"searchId,omitempty"`

	// an exact text search param used to filter the data on
...
// CreateManagedDomainJSONBody defines parameters for CreateManagedDomain.
type CreateManagedDomainJSONBody CreateManagedDomainRequest

// UpdateManagedDomainJSONBody defines parameters for UpdateManagedDomain.
type UpdateManagedDomainJSONBody UpdateManagedDomainRequest
...
type GetMetronomeDashboardParams struct {
	// optional flag to show zero usage line items for invoice dashboards
	ShowZeroUsageLineItems *bool `json:"showZeroUsageLineItems,omitempty"`

	// optional list of colors ('gray_dark', 'gray_medium', 'gray_light', 'gray_extralight', 'white', 'primary_medium', or 'primary_light')  to  override  in  the  format  'color:#hex-color-value'  Eg.  'gray_dark:#ff0000'
	ColorOverrides *[]string `json:"colorOverrides,omitempty"`
}
...
// ValidateCreditCardPaymentJSONBody defines parameters for ValidateCreditCardPayment.
type ValidateCreditCardPaymentJSONBody ValidateCreditCardPaymentRequest

// ListWorkspacesParams defines parameters for ListWorkspaces.
type ListWorkspacesParams struct {
	// list of workspace ids to get detail of
	WorkspaceIds *[]string `json:"workspaceIds,omitempty"`
	...
	// sorting criteria, each criterion should conform to format 'fieldName:asc' or 'fieldName:desc'
	Sorts *[]ListWorkspacesParamsSorts `json:"sorts,omitempty"`

	// string to search for when listing workspaces
	Search *string `json:"search,omitempty"`
}
...
type CreateWorkspaceJSONBody MutateWorkspaceRequest

// UpdateWorkspaceJSONBody defines parameters for UpdateWorkspace.
type UpdateWorkspaceJSONBody MutateWorkspaceRequest
...
type ListWorkspaceDagsParams struct {
	...
	// order-by fields, comma separated
	OrderBy *[]string `json:"orderBy,omitempty"`

	// pagination cursor
	Cursor *string `json:"cursor,omitempty"`

	// number of runs to include per dag, default of 0
	NumRuns *int `json:"numRuns,omitempty"`

	// filter by name of DAG (dagId)
	Name *string `json:"name,omitempty"`

	// filter by pattern for name of DAG (dagId),  SQL  syntax
	NameLike *string `json:"name__like,omitempty"`

	// filter by an owner of the dag
	Owner *string `json:"owner,omitempty"`

	// filter by paused dags
	IsPaused *bool `json:"isPaused,omitempty"`

	// filter by active dags
	IsActive *bool `json:"isActive,omitempty"`

	// filter by dag runs with any of these run states for its last run
	LastRunStateIn *[]string `json:"lastRunState__in,omitempty"`

	// filter by dag runs with any of these run states
	RunStateIn *[]string `json:"runState__in,omitempty"`

	// filter by dag run after specified datetime (RFC3339 format)
	RunAfter *time.Time `json:"runAfter,omitempty"`

	// filter by any of these tags
	TagIn *[]string `json:"tag__in,omitempty"`

	// filter by any of these deployment IDs
	DeploymentIdIn *[]string `json:"deploymentId__in,omitempty"`
}
...
type ValidateCreditCardPaymentJSONRequestBody ValidateCreditCardPaymentJSONBody
...
// Getter for additional properties for CreateOrganizationRequest_Metadata. Returns the specified
// element and whether it was found
func (a CreateOrganizationRequest_Metadata) Get(fieldName string) (value interface{}, found bool) {
...
// Setter for additional properties for CreateOrganizationRequest_Metadata
func (a *CreateOrganizationRequest_Metadata) Set(fieldName string, value interface{}) {
	if a.AdditionalProperties == nil {
...
// Override default JSON handling for CreateOrganizationRequest_Metadata to handle AdditionalProperties
func (a *CreateOrganizationRequest_Metadata) UnmarshalJSON(b []byte) error {
...
// Override default JSON handling for CreateOrganizationRequest_Metadata to handle AdditionalProperties
func (a CreateOrganizationRequest_Metadata) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
// Getter for additional properties for DagFilters_Deployments. Returns the specified
// element and whether it was found
func (a DagFilters_Deployments) Get(fieldName string) (value string, found bool) {
	if a.AdditionalProperties != nil {
		value, found = a.AdditionalProperties[fieldName]
	}
	return
...
// Setter for additional properties for DagFilters_Deployments
func (a *DagFilters_Deployments) Set(fieldName string, value string) {
	if a.AdditionalProperties == nil {
...
// Override default JSON handling for DagFilters_Deployments to handle AdditionalProperties
func (a *DagFilters_Deployments) UnmarshalJSON(b []byte) error {
	object := make(map[string]json.RawMessage)
	err := json.Unmarshal(b, &object)
	if err != nil {
		return err
...
// Override default JSON handling for DagFilters_Deployments to handle AdditionalProperties
func (a DagFilters_Deployments) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
// Getter for additional properties for InvoiceLineItem_CustomFields. Returns the specified
// element and whether it was found
func (a InvoiceLineItem_CustomFields) Get(fieldName string) (value string, found bool) {
	if a.AdditionalProperties != nil {
		value, found = a.AdditionalProperties[fieldName]
	}
	return
...
// Setter for additional properties for InvoiceLineItem_CustomFields
func (a *InvoiceLineItem_CustomFields) Set(fieldName string, value string) {
	if a.AdditionalProperties == nil {
		a.AdditionalProperties = make(map[string]string)
	}
	a.AdditionalProperties[fieldName] = value
...
// Override default JSON handling for InvoiceLineItem_CustomFields to handle AdditionalProperties
func (a *InvoiceLineItem_CustomFields) UnmarshalJSON(b []byte) error {
	object := make(map[string]json.RawMessage)
	err := json.Unmarshal(b, &object)
	if err != nil {
		return err
...
// Override default JSON handling for InvoiceLineItem_CustomFields to handle AdditionalProperties
func (a InvoiceLineItem_CustomFields) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
// Getter for additional properties for InvoiceSubLineItem_CustomFields. Returns the specified
// element and whether it was found
func (a InvoiceSubLineItem_CustomFields) Get(fieldName string) (value string, found bool) {
	if a.AdditionalProperties != nil {
		value, found = a.AdditionalProperties[fieldName]
	}
	return
...
// Setter for additional properties for InvoiceSubLineItem_CustomFields
func (a *InvoiceSubLineItem_CustomFields) Set(fieldName string, value string) {
	if a.AdditionalProperties == nil {
		a.AdditionalProperties = make(map[string]string)
	}
	a.AdditionalProperties[fieldName] = value
...
// Override default JSON handling for InvoiceSubLineItem_CustomFields to handle AdditionalProperties
func (a *InvoiceSubLineItem_CustomFields) UnmarshalJSON(b []byte) error {
	object := make(map[string]json.RawMessage)
	err := json.Unmarshal(b, &object)
	if err != nil {
		return err
...
// Override default JSON handling for InvoiceSubLineItem_CustomFields to handle AdditionalProperties
func (a InvoiceSubLineItem_CustomFields) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
// Getter for additional properties for PaymentMethod_Metadata. Returns the specified
// element and whether it was found
func (a PaymentMethod_Metadata) Get(fieldName string) (value string, found bool) {
	if a.AdditionalProperties != nil {
		value, found = a.AdditionalProperties[fieldName]
	}
	return
...
// Setter for additional properties for PaymentMethod_Metadata
func (a *PaymentMethod_Metadata) Set(fieldName string, value string) {
	if a.AdditionalProperties == nil {
		a.AdditionalProperties = make(map[string]string)
	}
	a.AdditionalProperties[fieldName] = value
...
// Override default JSON handling for PaymentMethod_Metadata to handle AdditionalProperties
func (a *PaymentMethod_Metadata) UnmarshalJSON(b []byte) error {
	object := make(map[string]json.RawMessage)
	err := json.Unmarshal(b, &object)
	if err != nil {
		return err
...
// Override default JSON handling for PaymentMethod_Metadata to handle AdditionalProperties
func (a PaymentMethod_Metadata) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
// Getter for additional properties for TaskInstance_RenderedFields. Returns the specified
// element and whether it was found
func (a TaskInstance_RenderedFields) Get(fieldName string) (value interface{}, found bool) {
	if a.AdditionalProperties != nil {
		value, found = a.AdditionalProperties[fieldName]
	}
	return
...
// Setter for additional properties for TaskInstance_RenderedFields
func (a *TaskInstance_RenderedFields) Set(fieldName string, value interface{}) {
	if a.AdditionalProperties == nil {
		a.AdditionalProperties = make(map[string]interface{})
	}
	a.AdditionalProperties[fieldName] = value
...
// Override default JSON handling for TaskInstance_RenderedFields to handle AdditionalProperties
func (a *TaskInstance_RenderedFields) UnmarshalJSON(b []byte) error {
	object := make(map[string]json.RawMessage)
	err := json.Unmarshal(b, &object)
	if err != nil {
		return err
...
// Override default JSON handling for TaskInstance_RenderedFields to handle AdditionalProperties
func (a TaskInstance_RenderedFields) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
// Getter for additional properties for UpdateOrganizationRequest_Metadata. Returns the specified
// element and whether it was found
func (a UpdateOrganizationRequest_Metadata) Get(fieldName string) (value interface{}, found bool) {
	if a.AdditionalProperties != nil {
		value, found = a.AdditionalProperties[fieldName]
	}
	return
...
// Setter for additional properties for UpdateOrganizationRequest_Metadata
func (a *UpdateOrganizationRequest_Metadata) Set(fieldName string, value interface{}) {
	if a.AdditionalProperties == nil {
		a.AdditionalProperties = make(map[string]interface{})
	}
	a.AdditionalProperties[fieldName] = value
...
// Override default JSON handling for UpdateOrganizationRequest_Metadata to handle AdditionalProperties
func (a *UpdateOrganizationRequest_Metadata) UnmarshalJSON(b []byte) error {
	object := make(map[string]json.RawMessage)
	err := json.Unmarshal(b, &object)
	if err != nil {
		return err
...
// Override default JSON handling for UpdateOrganizationRequest_Metadata to handle AdditionalProperties
func (a UpdateOrganizationRequest_Metadata) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
// Getter for additional properties for InternalMappedTaskInstanceSummary_States. Returns the specified
// element and whether it was found
func (a InternalMappedTaskInstanceSummary_States) Get(fieldName string) (value int, found bool) {
	if a.AdditionalProperties != nil {
		value, found = a.AdditionalProperties[fieldName]
	}
	return
...
// Setter for additional properties for InternalMappedTaskInstanceSummary_States
func (a *InternalMappedTaskInstanceSummary_States) Set(fieldName string, value int) {
	if a.AdditionalProperties == nil {
...
// Override default JSON handling for InternalMappedTaskInstanceSummary_States to handle AdditionalProperties
func (a *InternalMappedTaskInstanceSummary_States) UnmarshalJSON(b []byte) error {
	object := make(map[string]json.RawMessage)
	err := json.Unmarshal(b, &object)
	if err != nil {
		return err
...
// Override default JSON handling for InternalMappedTaskInstanceSummary_States to handle AdditionalProperties
func (a InternalMappedTaskInstanceSummary_States) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
// Getter for additional properties for InternalOutlet_Extra. Returns the specified
// element and whether it was found
func (a InternalOutlet_Extra) Get(fieldName string) (value string, found bool) {
	if a.AdditionalProperties != nil {
		value, found = a.AdditionalProperties[fieldName]
	}
	return
...
// Setter for additional properties for InternalOutlet_Extra
func (a *InternalOutlet_Extra) Set(fieldName string, value string) {
	if a.AdditionalProperties == nil {
		a.AdditionalProperties = make(map[string]string)
	}
	a.AdditionalProperties[fieldName] = value
...
// Override default JSON handling for InternalOutlet_Extra to handle AdditionalProperties
func (a *InternalOutlet_Extra) UnmarshalJSON(b []byte) error {
	object := make(map[string]json.RawMessage)
	err := json.Unmarshal(b, &object)
	if err != nil {
		return err
...
// Override default JSON handling for InternalOutlet_Extra to handle AdditionalProperties
func (a InternalOutlet_Extra) MarshalJSON() ([]byte, error) {
	var err error
	object := make(map[string]json.RawMessage)
...
type ClientInterface interface {
	...
	GetDeploymentDagRuns(ctx context.Context, orgShortNameId string, deploymentId string, dagId string, params *GetDeploymentDagRunsParams, reqEditors ...RequestEditorFn) (*http.Response, error)

	// GetDeploymentDagStructure request
	GetDeploymentDagStructure(ctx context.Context, orgShortNameId string, deploymentId string, dagId string, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) GetDeploymentDagRuns(ctx context.Context, orgShortNameId string, deploymentId string, dagId string, params *GetDeploymentDagRunsParams, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetDeploymentDagRunsRequest(c.Server, orgShortNameId, deploymentId, dagId, params)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) GetDeploymentDagStructure(ctx context.Context, orgShortNameId string, deploymentId string, dagId string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetDeploymentDagStructureRequest(c.Server, orgShortNameId, deploymentId, dagId)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewGetDeploymentDagRunsRequest(server string, orgShortNameId string, deploymentId string, dagId string, params *GetDeploymentDagRunsParams) (*http.Request, error) {
	var err error
...
func NewGetDeploymentDagStructureRequest(server string, orgShortNameId string, deploymentId string, dagId string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// GetDeploymentDagRuns request
	GetDeploymentDagRunsWithResponse(ctx context.Context, orgShortNameId string, deploymentId string, dagId string, params *GetDeploymentDagRunsParams, reqEditors ...RequestEditorFn) (*GetDeploymentDagRunsResponse, error)

	// GetDeploymentDagStructure request
	GetDeploymentDagStructureWithResponse(ctx context.Context, orgShortNameId string, deploymentId string, dagId string, reqEditors ...RequestEditorFn) (*GetDeploymentDagStructureResponse, error)
...
func (c *ClientWithResponses) GetDeploymentDagRunsWithResponse(ctx context.Context, orgShortNameId string, deploymentId string, dagId string, params *GetDeploymentDagRunsParams, reqEditors ...RequestEditorFn) (*GetDeploymentDagRunsResponse, error) {
	rsp, err := c.GetDeploymentDagRuns(ctx, orgShortNameId, deploymentId, dagId, params, reqEditors...)
	if err != nil {
		return nil, err
	}
...
func (c *ClientWithResponses) GetDeploymentDagStructureWithResponse(ctx context.Context, orgShortNameId string, deploymentId string, dagId string, reqEditors ...RequestEditorFn) (*GetDeploymentDagStructureResponse, error) {
	rsp, err := c.GetDeploymentDagStructure(ctx, orgShortNameId, deploymentId, dagId, reqEditors...)
	if err != nil {
		return nil, err
	}
