...
func (h HoustonClientImplementation) ListUsersInDeployment(filters ListUsersInDeploymentRequest) ([]DeploymentUser, error) {
...
func (h HoustonClientImplementation) AddUserToDeployment(variables UpdateUserInDeploymentRequest) (*RoleBinding, error) {
	req := Request{
...
func (h HoustonClientImplementation) UpdateUserInDeployment(variables UpdateUserInDeploymentRequest) (*RoleBinding, error) {
	req := Request{
...
func (h HoustonClientImplementation) DeleteUserFromDeployment(deploymentID, email string) (*RoleBinding, error) {
	req := Request{
