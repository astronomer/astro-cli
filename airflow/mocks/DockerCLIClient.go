...
// DockerCLIClient is an autogenerated mock type for the DockerCLIClient type
...
func (_m *DockerCLIClient) BuildCancel(ctx context.Context, id string) error {
...
func (_m *DockerCLIClient) CheckpointCreate(ctx context.Context, _a1 string, options types.CheckpointCreateOptions) error {
...
func (_m *DockerCLIClient) CheckpointDelete(ctx context.Context, _a1 string, options types.CheckpointDeleteOptions) error {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerCLIClient) CheckpointList(ctx context.Context, _a1 string, options types.CheckpointListOptions) ([]types.Checkpoint, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerCLIClient) ClientVersion() string {
	ret := _m.Called()
...
func (_m *DockerCLIClient) Close() error {
	ret := _m.Called()
...
func (_m *DockerCLIClient) ConfigInspectWithRaw(ctx context.Context, name string) (swarm.Config, []byte, error) {
...
func (_m *DockerCLIClient) ConfigRemove(ctx context.Context, id string) error {
	ret := _m.Called(ctx, id)
...
func (_m *DockerCLIClient) ConfigUpdate(ctx context.Context, id string, version swarm.Version, config swarm.ConfigSpec) error {
...
func (_m *DockerCLIClient) ContainerAttach(ctx context.Context, _a1 string, options types.ContainerAttachOptions) (types.HijackedResponse, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerCLIClient) ContainerCommit(ctx context.Context, _a1 string, options types.ContainerCommitOptions) (types.IDResponse, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerCLIClient) ContainerCreate(ctx context.Context, config *container.Config, hostConfig *container.HostConfig, networkingConfig *network.NetworkingConfig, platform *v1.Platform, containerName string) (container.ContainerCreateCreatedBody, error) {
...
func (_m *DockerCLIClient) ContainerDiff(ctx context.Context, _a1 string) ([]container.ContainerChangeResponseItem, error) {
...
func (_m *DockerCLIClient) ContainerExecAttach(ctx context.Context, execID string, config types.ExecStartCheck) (types.HijackedResponse, error) {
...
func (_m *DockerCLIClient) ContainerExecCreate(ctx context.Context, _a1 string, config types.ExecConfig) (types.IDResponse, error) {
...
func (_m *DockerCLIClient) ContainerExecInspect(ctx context.Context, execID string) (types.ContainerExecInspect, error) {
...
func (_m *DockerCLIClient) ContainerExecResize(ctx context.Context, execID string, options types.ResizeOptions) error {
...
func (_m *DockerCLIClient) ContainerExecStart(ctx context.Context, execID string, config types.ExecStartCheck) error {
	ret := _m.Called(ctx, execID, config)
...
func (_m *DockerCLIClient) ContainerExport(ctx context.Context, _a1 string) (io.ReadCloser, error) {
	ret := _m.Called(ctx, _a1)
...
func (_m *DockerCLIClient) ContainerKill(ctx context.Context, _a1 string, signal string) error {
...
func (_m *DockerCLIClient) ContainerList(ctx context.Context, options types.ContainerListOptions) ([]types.Container, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerCLIClient) ContainerLogs(ctx context.Context, _a1 string, options types.ContainerLogsOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerCLIClient) ContainerPause(ctx context.Context, _a1 string) error {
	ret := _m.Called(ctx, _a1)
...
func (_m *DockerCLIClient) ContainerRemove(ctx context.Context, _a1 string, options types.ContainerRemoveOptions) error {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerCLIClient) ContainerRename(ctx context.Context, _a1 string, newContainerName string) error {
...
func (_m *DockerCLIClient) ContainerResize(ctx context.Context, _a1 string, options types.ResizeOptions) error {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerCLIClient) ContainerRestart(ctx context.Context, _a1 string, timeout *time.Duration) error {
...
func (_m *DockerCLIClient) ContainerStart(ctx context.Context, _a1 string, options types.ContainerStartOptions) error {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerCLIClient) ContainerStatPath(ctx context.Context, _a1 string, path string) (types.ContainerPathStat, error) {
...
func (_m *DockerCLIClient) ContainerStats(ctx context.Context, _a1 string, stream bool) (types.ContainerStats, error) {
...
func (_m *DockerCLIClient) ContainerStatsOneShot(ctx context.Context, _a1 string) (types.ContainerStats, error) {
	ret := _m.Called(ctx, _a1)
...
func (_m *DockerCLIClient) ContainerStop(ctx context.Context, _a1 string, timeout *time.Duration) error {
	ret := _m.Called(ctx, _a1, timeout)
...
func (_m *DockerCLIClient) ContainerUnpause(ctx context.Context, _a1 string) error {
	ret := _m.Called(ctx, _a1)
...
func (_m *DockerCLIClient) ContainerWait(ctx context.Context, _a1 string, condition container.WaitCondition) (<-chan container.ContainerWaitOKBody, <-chan error) {
...
func (_m *DockerCLIClient) ContainersPrune(ctx context.Context, pruneFilters filters.Args) (types.ContainersPruneReport, error) {
...
func (_m *DockerCLIClient) CopyFromContainer(ctx context.Context, _a1 string, srcPath string) (io.ReadCloser, types.ContainerPathStat, error) {
...
func (_m *DockerCLIClient) CopyToContainer(ctx context.Context, _a1 string, path string, content io.Reader, options types.CopyToContainerOptions) error {
...
func (_m *DockerCLIClient) DaemonHost() string {
	ret := _m.Called()
...
func (_m *DockerCLIClient) DialHijack(ctx context.Context, url string, proto string, meta map[string][]string) (net.Conn, error) {
...
func (_m *DockerCLIClient) Dialer() func(context.Context) (net.Conn, error) {
	ret := _m.Called()
...
func (_m *DockerCLIClient) DiskUsage(ctx context.Context) (types.DiskUsage, error) {
	ret := _m.Called(ctx)
...
func (_m *DockerCLIClient) DistributionInspect(ctx context.Context, _a1 string, encodedRegistryAuth string) (registry.DistributionInspect, error) {
...
func (_m *DockerCLIClient) Events(ctx context.Context, options types.EventsOptions) (<-chan events.Message, <-chan error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerCLIClient) HTTPClient() *http.Client {
	ret := _m.Called()
...
func (_m *DockerCLIClient) ImageCreate(ctx context.Context, parentReference string, options types.ImageCreateOptions) (io.ReadCloser, error) {
...
func (_m *DockerCLIClient) ImageImport(ctx context.Context, source types.ImageImportSource, ref string, options types.ImageImportOptions) (io.ReadCloser, error) {
...
func (_m *DockerCLIClient) ImageList(ctx context.Context, options types.ImageListOptions) ([]types.ImageSummary, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerCLIClient) ImageLoad(ctx context.Context, input io.Reader, quiet bool) (types.ImageLoadResponse, error) {
...
func (_m *DockerCLIClient) ImagePull(ctx context.Context, ref string, options types.ImagePullOptions) (io.ReadCloser, error) {
...
func (_m *DockerCLIClient) ImagePush(ctx context.Context, ref string, options types.ImagePushOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, ref, options)
...
func (_m *DockerCLIClient) ImageRemove(ctx context.Context, _a1 string, options types.ImageRemoveOptions) ([]types.ImageDeleteResponseItem, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerCLIClient) ImageSearch(ctx context.Context, term string, options types.ImageSearchOptions) ([]registry.SearchResult, error) {
...
func (_m *DockerCLIClient) ImageTag(ctx context.Context, _a1 string, ref string) error {
...
func (_m *DockerCLIClient) ImagesPrune(ctx context.Context, pruneFilter filters.Args) (types.ImagesPruneReport, error) {
...
func (_m *DockerCLIClient) Info(ctx context.Context) (types.Info, error) {
	ret := _m.Called(ctx)
...
func (_m *DockerCLIClient) NegotiateAPIVersion(ctx context.Context) {
	_m.Called(ctx)
}

// NegotiateAPIVersionPing provides a mock function with given fields: _a0
func (_m *DockerCLIClient) NegotiateAPIVersionPing(_a0 types.Ping) {
	_m.Called(_a0)
}

// NetworkConnect provides a mock function with given fields: ctx, _a1, _a2, config
func (_m *DockerCLIClient) NetworkConnect(ctx context.Context, _a1 string, _a2 string, config *network.EndpointSettings) error {
...
func (_m *DockerCLIClient) NetworkCreate(ctx context.Context, name string, options types.NetworkCreate) (types.NetworkCreateResponse, error) {
...
func (_m *DockerCLIClient) NetworkDisconnect(ctx context.Context, _a1 string, _a2 string, force bool) error {
...
func (_m *DockerCLIClient) NetworkInspect(ctx context.Context, _a1 string, options types.NetworkInspectOptions) (types.NetworkResource, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerCLIClient) NetworkInspectWithRaw(ctx context.Context, _a1 string, options types.NetworkInspectOptions) (types.NetworkResource, []byte, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerCLIClient) NetworkList(ctx context.Context, options types.NetworkListOptions) ([]types.NetworkResource, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerCLIClient) NetworkRemove(ctx context.Context, _a1 string) error {
	ret := _m.Called(ctx, _a1)
...
func (_m *DockerCLIClient) NetworksPrune(ctx context.Context, pruneFilter filters.Args) (types.NetworksPruneReport, error) {
	ret := _m.Called(ctx, pruneFilter)
...
func (_m *DockerCLIClient) NodeInspectWithRaw(ctx context.Context, nodeID string) (swarm.Node, []byte, error) {
...
func (_m *DockerCLIClient) NodeUpdate(ctx context.Context, nodeID string, version swarm.Version, node swarm.NodeSpec) error {
...
func (_m *DockerCLIClient) Ping(ctx context.Context) (types.Ping, error) {
	ret := _m.Called(ctx)
...
func (_m *DockerCLIClient) PluginCreate(ctx context.Context, createContext io.Reader, options types.PluginCreateOptions) error {
...
func (_m *DockerCLIClient) PluginDisable(ctx context.Context, name string, options types.PluginDisableOptions) error {
	ret := _m.Called(ctx, name, options)
...
func (_m *DockerCLIClient) PluginEnable(ctx context.Context, name string, options types.PluginEnableOptions) error {
	ret := _m.Called(ctx, name, options)
...
func (_m *DockerCLIClient) PluginInspectWithRaw(ctx context.Context, name string) (*types.Plugin, []byte, error) {
	ret := _m.Called(ctx, name)
...
func (_m *DockerCLIClient) PluginInstall(ctx context.Context, name string, options types.PluginInstallOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, name, options)
...
func (_m *DockerCLIClient) PluginList(ctx context.Context, filter filters.Args) (types.PluginsListResponse, error) {
...
func (_m *DockerCLIClient) PluginPush(ctx context.Context, name string, registryAuth string) (io.ReadCloser, error) {
...
func (_m *DockerCLIClient) PluginRemove(ctx context.Context, name string, options types.PluginRemoveOptions) error {
	ret := _m.Called(ctx, name, options)
...
func (_m *DockerCLIClient) PluginSet(ctx context.Context, name string, args []string) error {
...
func (_m *DockerCLIClient) PluginUpgrade(ctx context.Context, name string, options types.PluginInstallOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, name, options)
...
func (_m *DockerCLIClient) RegistryLogin(ctx context.Context, auth types.AuthConfig) (registry.AuthenticateOKBody, error) {
...
func (_m *DockerCLIClient) SecretInspectWithRaw(ctx context.Context, name string) (swarm.Secret, []byte, error) {
	ret := _m.Called(ctx, name)
...
func (_m *DockerCLIClient) SecretRemove(ctx context.Context, id string) error {
	ret := _m.Called(ctx, id)
...
func (_m *DockerCLIClient) SecretUpdate(ctx context.Context, id string, version swarm.Version, secret swarm.SecretSpec) error {
...
func (_m *DockerCLIClient) ServerVersion(ctx context.Context) (types.Version, error) {
	ret := _m.Called(ctx)
...
func (_m *DockerCLIClient) ServiceCreate(ctx context.Context, service swarm.ServiceSpec, options types.ServiceCreateOptions) (types.ServiceCreateResponse, error) {
...
func (_m *DockerCLIClient) ServiceLogs(ctx context.Context, serviceID string, options types.ContainerLogsOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, serviceID, options)
...
func (_m *DockerCLIClient) ServiceRemove(ctx context.Context, serviceID string) error {
...
func (_m *DockerCLIClient) ServiceUpdate(ctx context.Context, serviceID string, version swarm.Version, service swarm.ServiceSpec, options types.ServiceUpdateOptions) (types.ServiceUpdateResponse, error) {
...
func (_m *DockerCLIClient) SwarmInit(ctx context.Context, req swarm.InitRequest) (string, error) {
...
func (_m *DockerCLIClient) SwarmInspect(ctx context.Context) (swarm.Swarm, error) {
	ret := _m.Called(ctx)
...
func (_m *DockerCLIClient) SwarmJoin(ctx context.Context, req swarm.JoinRequest) error {
	ret := _m.Called(ctx, req)
...
func (_m *DockerCLIClient) SwarmLeave(ctx context.Context, force bool) error {
...
func (_m *DockerCLIClient) SwarmUnlock(ctx context.Context, req swarm.UnlockRequest) error {
	ret := _m.Called(ctx, req)
...
func (_m *DockerCLIClient) SwarmUpdate(ctx context.Context, version swarm.Version, _a2 swarm.Spec, flags swarm.UpdateFlags) error {
...
func (_m *DockerCLIClient) TaskInspectWithRaw(ctx context.Context, taskID string) (swarm.Task, []byte, error) {
...
func (_m *DockerCLIClient) TaskLogs(ctx context.Context, taskID string, options types.ContainerLogsOptions) (io.ReadCloser, error) {
...
func (_m *DockerCLIClient) VolumeCreate(ctx context.Context, options volume.VolumeCreateBody) (types.Volume, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerCLIClient) VolumeInspect(ctx context.Context, volumeID string) (types.Volume, error) {
...
func (_m *DockerCLIClient) VolumeInspectWithRaw(ctx context.Context, volumeID string) (types.Volume, []byte, error) {
	ret := _m.Called(ctx, volumeID)
...
func (_m *DockerCLIClient) VolumeList(ctx context.Context, filter filters.Args) (volume.VolumeListOKBody, error) {
	ret := _m.Called(ctx, filter)
...
func (_m *DockerCLIClient) VolumeRemove(ctx context.Context, volumeID string, force bool) error {
...
func (_m *DockerCLIClient) VolumesPrune(ctx context.Context, pruneFilter filters.Args) (types.VolumesPruneReport, error) {
	ret := _m.Called(ctx, pruneFilter)
...
type mockConstructorTestingTNewDockerCLIClient interface {
	mock.TestingT
	Cleanup(func())
}

// NewDockerCLIClient creates a new instance of DockerCLIClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewDockerCLIClient(t mockConstructorTestingTNewDockerCLIClient) *DockerCLIClient {
	mock := &DockerCLIClient{}
	mock.Mock.Test(t)
