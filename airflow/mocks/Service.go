...
func (_m *Service) Build(ctx context.Context, project *types.Project, options api.BuildOptions) error {
...
func (_m *Service) Convert(ctx context.Context, project *types.Project, options api.ConvertOptions) ([]byte, error) {
	ret := _m.Called(ctx, project, options)
...
func (_m *Service) Copy(ctx context.Context, project *types.Project, opts api.CopyOptions) error {
...
func (_m *Service) Create(ctx context.Context, project *types.Project, opts api.CreateOptions) error {
	ret := _m.Called(ctx, project, opts)
...
func (_m *Service) Down(ctx context.Context, projectName string, options api.DownOptions) error {
...
func (_m *Service) Events(ctx context.Context, project string, options api.EventsOptions) error {
	ret := _m.Called(ctx, project, options)
...
func (_m *Service) Exec(ctx context.Context, project string, opts api.RunOptions) (int, error) {
	ret := _m.Called(ctx, project, opts)
...
func (_m *Service) Images(ctx context.Context, projectName string, options api.ImagesOptions) ([]api.ImageSummary, error) {
	ret := _m.Called(ctx, projectName, options)
...
func (_m *Service) Kill(ctx context.Context, project *types.Project, options api.KillOptions) error {
	ret := _m.Called(ctx, project, options)
...
func (_m *Service) List(ctx context.Context, options api.ListOptions) ([]api.Stack, error) {
...
func (_m *Service) Logs(ctx context.Context, projectName string, consumer api.LogConsumer, options api.LogOptions) error {
...
func (_m *Service) Pause(ctx context.Context, project string, options api.PauseOptions) error {
	ret := _m.Called(ctx, project, options)
...
func (_m *Service) Port(ctx context.Context, project string, service string, port int, options api.PortOptions) (string, int, error) {
...
func (_m *Service) Ps(ctx context.Context, projectName string, options api.PsOptions) ([]api.ContainerSummary, error) {
	ret := _m.Called(ctx, projectName, options)
...
func (_m *Service) Pull(ctx context.Context, project *types.Project, opts api.PullOptions) error {
	ret := _m.Called(ctx, project, opts)
...
func (_m *Service) Push(ctx context.Context, project *types.Project, options api.PushOptions) error {
	ret := _m.Called(ctx, project, options)
...
func (_m *Service) Remove(ctx context.Context, project *types.Project, options api.RemoveOptions) error {
	ret := _m.Called(ctx, project, options)
...
func (_m *Service) Restart(ctx context.Context, project *types.Project, options api.RestartOptions) error {
	ret := _m.Called(ctx, project, options)
...
func (_m *Service) RunOneOffContainer(ctx context.Context, project *types.Project, opts api.RunOptions) (int, error) {
	ret := _m.Called(ctx, project, opts)
...
func (_m *Service) Start(ctx context.Context, project *types.Project, options api.StartOptions) error {
	ret := _m.Called(ctx, project, options)
...
func (_m *Service) Stop(ctx context.Context, project *types.Project, options api.StopOptions) error {
	ret := _m.Called(ctx, project, options)
...
func (_m *Service) Top(ctx context.Context, projectName string, services []string) ([]api.ContainerProcSummary, error) {
...
func (_m *Service) UnPause(ctx context.Context, project string, options api.PauseOptions) error {
	ret := _m.Called(ctx, project, options)
...
func (_m *Service) Up(ctx context.Context, project *types.Project, options api.UpOptions) error {
	ret := _m.Called(ctx, project, options)
