...
// UpgradeTest provides a mock function with given fields: runtimeVersion, deploymentID, dependencyTest, versionTest, dagTest, client
func (_m *ContainerHandler) UpgradeTest(runtimeVersion string, deploymentID string, dependencyTest bool, versionTest bool, dagTest bool, client astro.Client) error {
	ret := _m.Called(runtimeVersion, deploymentID, dependencyTest, versionTest, dagTest, client)

	var r0 error
	if rf, ok := ret.Get(0).(func(string, string, bool, bool, bool, astro.Client) error); ok {
		r0 = rf(runtimeVersion, deploymentID, dependencyTest, versionTest, dagTest, client)
	} else {
		r0 = ret.Error(0)
	}
