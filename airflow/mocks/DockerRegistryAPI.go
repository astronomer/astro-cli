...
// DockerRegistryAPI is an autogenerated mock type for the DockerRegistryAPI type
type DockerRegistryAPI struct {
	mock.Mock
}

// BuildCachePrune provides a mock function with given fields: ctx, opts
func (_m *DockerRegistryAPI) BuildCachePrune(ctx context.Context, opts build.CachePruneOptions) (*build.CachePruneReport, error) {
...
func (_m *DockerRegistryAPI) BuildCancel(ctx context.Context, id string) error {
...
func (_m *DockerRegistryAPI) CheckpointCreate(ctx context.Context, _a1 string, options checkpoint.CreateOptions) error {
...
func (_m *DockerRegistryAPI) CheckpointDelete(ctx context.Context, _a1 string, options checkpoint.DeleteOptions) error {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) CheckpointList(ctx context.Context, _a1 string, options checkpoint.ListOptions) ([]checkpoint.Summary, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) ClientVersion() string {
	ret := _m.Called()
...
func (_m *DockerRegistryAPI) Close() error {
	ret := _m.Called()
...
func (_m *DockerRegistryAPI) ConfigCreate(ctx context.Context, config swarm.ConfigSpec) (swarm.ConfigCreateResponse, error) {
...
func (_m *DockerRegistryAPI) ConfigInspectWithRaw(ctx context.Context, name string) (swarm.Config, []byte, error) {
...
func (_m *DockerRegistryAPI) ConfigList(ctx context.Context, options swarm.ConfigListOptions) ([]swarm.Config, error) {
...
func (_m *DockerRegistryAPI) ConfigRemove(ctx context.Context, id string) error {
	ret := _m.Called(ctx, id)
...
func (_m *DockerRegistryAPI) ConfigUpdate(ctx context.Context, id string, version swarm.Version, config swarm.ConfigSpec) error {
...
func (_m *DockerRegistryAPI) ContainerAttach(ctx context.Context, _a1 string, options container.AttachOptions) (types.HijackedResponse, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) ContainerCommit(ctx context.Context, _a1 string, options container.CommitOptions) (common.IDResponse, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) ContainerCreate(ctx context.Context, config *container.Config, hostConfig *container.HostConfig, networkingConfig *network.NetworkingConfig, platform *v1.Platform, containerName string) (container.CreateResponse, error) {
...
func (_m *DockerRegistryAPI) ContainerDiff(ctx context.Context, _a1 string) ([]container.FilesystemChange, error) {
...
func (_m *DockerRegistryAPI) ContainerExecAttach(ctx context.Context, execID string, options container.ExecStartOptions) (types.HijackedResponse, error) {
...
func (_m *DockerRegistryAPI) ContainerExecCreate(ctx context.Context, _a1 string, options container.ExecOptions) (common.IDResponse, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) ContainerExecInspect(ctx context.Context, execID string) (container.ExecInspect, error) {
...
func (_m *DockerRegistryAPI) ContainerExecResize(ctx context.Context, execID string, options container.ResizeOptions) error {
	ret := _m.Called(ctx, execID, options)
...
func (_m *DockerRegistryAPI) ContainerExecStart(ctx context.Context, execID string, options container.ExecStartOptions) error {
	ret := _m.Called(ctx, execID, options)
...
func (_m *DockerRegistryAPI) ContainerExport(ctx context.Context, _a1 string) (io.ReadCloser, error) {
	ret := _m.Called(ctx, _a1)
...
func (_m *DockerRegistryAPI) ContainerInspect(ctx context.Context, _a1 string) (container.InspectResponse, error) {
	ret := _m.Called(ctx, _a1)
...
func (_m *DockerRegistryAPI) ContainerInspectWithRaw(ctx context.Context, _a1 string, getSize bool) (container.InspectResponse, []byte, error) {
...
func (_m *DockerRegistryAPI) ContainerKill(ctx context.Context, _a1 string, signal string) error {
...
func (_m *DockerRegistryAPI) ContainerList(ctx context.Context, options container.ListOptions) ([]container.Summary, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerRegistryAPI) ContainerLogs(ctx context.Context, _a1 string, options container.LogsOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) ContainerPause(ctx context.Context, _a1 string) error {
	ret := _m.Called(ctx, _a1)
...
func (_m *DockerRegistryAPI) ContainerRemove(ctx context.Context, _a1 string, options container.RemoveOptions) error {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) ContainerRename(ctx context.Context, _a1 string, newContainerName string) error {
...
func (_m *DockerRegistryAPI) ContainerResize(ctx context.Context, _a1 string, options container.ResizeOptions) error {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) ContainerRestart(ctx context.Context, _a1 string, options container.StopOptions) error {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) ContainerStart(ctx context.Context, _a1 string, options container.StartOptions) error {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) ContainerStatPath(ctx context.Context, _a1 string, path string) (container.PathStat, error) {
...
func (_m *DockerRegistryAPI) ContainerStats(ctx context.Context, _a1 string, stream bool) (container.StatsResponseReader, error) {
...
func (_m *DockerRegistryAPI) ContainerStatsOneShot(ctx context.Context, _a1 string) (container.StatsResponseReader, error) {
	ret := _m.Called(ctx, _a1)
...
func (_m *DockerRegistryAPI) ContainerStop(ctx context.Context, _a1 string, options container.StopOptions) error {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) ContainerTop(ctx context.Context, _a1 string, arguments []string) (container.TopResponse, error) {
...
func (_m *DockerRegistryAPI) ContainerUnpause(ctx context.Context, _a1 string) error {
	ret := _m.Called(ctx, _a1)
...
func (_m *DockerRegistryAPI) ContainerUpdate(ctx context.Context, _a1 string, updateConfig container.UpdateConfig) (container.UpdateResponse, error) {
...
func (_m *DockerRegistryAPI) ContainerWait(ctx context.Context, _a1 string, condition container.WaitCondition) (<-chan container.WaitResponse, <-chan error) {
...
func (_m *DockerRegistryAPI) ContainersPrune(ctx context.Context, pruneFilters filters.Args) (container.PruneReport, error) {
...
func (_m *DockerRegistryAPI) CopyFromContainer(ctx context.Context, _a1 string, srcPath string) (io.ReadCloser, container.PathStat, error) {
...
func (_m *DockerRegistryAPI) CopyToContainer(ctx context.Context, _a1 string, path string, content io.Reader, options container.CopyToContainerOptions) error {
...
func (_m *DockerRegistryAPI) DaemonHost() string {
	ret := _m.Called()
...
func (_m *DockerRegistryAPI) DialHijack(ctx context.Context, url string, proto string, meta map[string][]string) (net.Conn, error) {
...
func (_m *DockerRegistryAPI) Dialer() func(context.Context) (net.Conn, error) {
	ret := _m.Called()
...
func (_m *DockerRegistryAPI) DiskUsage(ctx context.Context, options types.DiskUsageOptions) (types.DiskUsage, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerRegistryAPI) DistributionInspect(ctx context.Context, _a1 string, encodedRegistryAuth string) (registry.DistributionInspect, error) {
...
func (_m *DockerRegistryAPI) Events(ctx context.Context, options events.ListOptions) (<-chan events.Message, <-chan error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerRegistryAPI) HTTPClient() *http.Client {
	ret := _m.Called()
...
func (_m *DockerRegistryAPI) ImageBuild(ctx context.Context, _a1 io.Reader, options build.ImageBuildOptions) (build.ImageBuildResponse, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) ImageCreate(ctx context.Context, parentReference string, options image.CreateOptions) (io.ReadCloser, error) {
...
func (_m *DockerRegistryAPI) ImageHistory(ctx context.Context, _a1 string, _a2 ...client.ImageHistoryOption) ([]image.HistoryResponseItem, error) {
...
func (_m *DockerRegistryAPI) ImageImport(ctx context.Context, source image.ImportSource, ref string, options image.ImportOptions) (io.ReadCloser, error) {
...
func (_m *DockerRegistryAPI) ImageInspect(ctx context.Context, _a1 string, _a2 ...client.ImageInspectOption) (image.InspectResponse, error) {
	_va := make([]interface{}, len(_a2))
	for _i := range _a2 {
		_va[_i] = _a2[_i]
	}
...
func (_m *DockerRegistryAPI) ImageInspectWithRaw(ctx context.Context, _a1 string) (image.InspectResponse, []byte, error) {
	ret := _m.Called(ctx, _a1)
...
func (_m *DockerRegistryAPI) ImageList(ctx context.Context, options image.ListOptions) ([]image.Summary, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerRegistryAPI) ImageLoad(ctx context.Context, input io.Reader, _a2 ...client.ImageLoadOption) (image.LoadResponse, error) {
	_va := make([]interface{}, len(_a2))
	for _i := range _a2 {
		_va[_i] = _a2[_i]
	}
...
func (_m *DockerRegistryAPI) ImagePull(ctx context.Context, ref string, options image.PullOptions) (io.ReadCloser, error) {
...
func (_m *DockerRegistryAPI) ImagePush(ctx context.Context, ref string, options image.PushOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, ref, options)
...
func (_m *DockerRegistryAPI) ImageRemove(ctx context.Context, _a1 string, options image.RemoveOptions) ([]image.DeleteResponse, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) ImageSave(ctx context.Context, images []string, _a2 ...client.ImageSaveOption) (io.ReadCloser, error) {
	_va := make([]interface{}, len(_a2))
	for _i := range _a2 {
		_va[_i] = _a2[_i]
	}
...
func (_m *DockerRegistryAPI) ImageSearch(ctx context.Context, term string, options registry.SearchOptions) ([]registry.SearchResult, error) {
...
func (_m *DockerRegistryAPI) ImageTag(ctx context.Context, _a1 string, ref string) error {
...
func (_m *DockerRegistryAPI) ImagesPrune(ctx context.Context, pruneFilter filters.Args) (image.PruneReport, error) {
...
func (_m *DockerRegistryAPI) Info(ctx context.Context) (system.Info, error) {
	ret := _m.Called(ctx)
...
func (_m *DockerRegistryAPI) NegotiateAPIVersion(ctx context.Context) {
	_m.Called(ctx)
}

// NegotiateAPIVersionPing provides a mock function with given fields: _a0
func (_m *DockerRegistryAPI) NegotiateAPIVersionPing(_a0 types.Ping) {
	_m.Called(_a0)
}

// NetworkConnect provides a mock function with given fields: ctx, _a1, _a2, config
func (_m *DockerRegistryAPI) NetworkConnect(ctx context.Context, _a1 string, _a2 string, config *network.EndpointSettings) error {
...
func (_m *DockerRegistryAPI) NetworkCreate(ctx context.Context, name string, options network.CreateOptions) (network.CreateResponse, error) {
...
func (_m *DockerRegistryAPI) NetworkDisconnect(ctx context.Context, _a1 string, _a2 string, force bool) error {
...
func (_m *DockerRegistryAPI) NetworkInspect(ctx context.Context, _a1 string, options network.InspectOptions) (network.Inspect, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) NetworkInspectWithRaw(ctx context.Context, _a1 string, options network.InspectOptions) (network.Inspect, []byte, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) NetworkList(ctx context.Context, options network.ListOptions) ([]network.Inspect, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerRegistryAPI) NetworkRemove(ctx context.Context, _a1 string) error {
	ret := _m.Called(ctx, _a1)
...
func (_m *DockerRegistryAPI) NetworksPrune(ctx context.Context, pruneFilter filters.Args) (network.PruneReport, error) {
	ret := _m.Called(ctx, pruneFilter)
...
func (_m *DockerRegistryAPI) NodeInspectWithRaw(ctx context.Context, nodeID string) (swarm.Node, []byte, error) {
...
func (_m *DockerRegistryAPI) NodeList(ctx context.Context, options swarm.NodeListOptions) ([]swarm.Node, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerRegistryAPI) NodeRemove(ctx context.Context, nodeID string, options swarm.NodeRemoveOptions) error {
...
func (_m *DockerRegistryAPI) NodeUpdate(ctx context.Context, nodeID string, version swarm.Version, node swarm.NodeSpec) error {
...
func (_m *DockerRegistryAPI) Ping(ctx context.Context) (types.Ping, error) {
	ret := _m.Called(ctx)
...
func (_m *DockerRegistryAPI) PluginCreate(ctx context.Context, createContext io.Reader, options types.PluginCreateOptions) error {
...
func (_m *DockerRegistryAPI) PluginDisable(ctx context.Context, name string, options types.PluginDisableOptions) error {
	ret := _m.Called(ctx, name, options)
...
func (_m *DockerRegistryAPI) PluginEnable(ctx context.Context, name string, options types.PluginEnableOptions) error {
	ret := _m.Called(ctx, name, options)
...
func (_m *DockerRegistryAPI) PluginInspectWithRaw(ctx context.Context, name string) (*types.Plugin, []byte, error) {
	ret := _m.Called(ctx, name)
...
func (_m *DockerRegistryAPI) PluginInstall(ctx context.Context, name string, options types.PluginInstallOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, name, options)
...
func (_m *DockerRegistryAPI) PluginList(ctx context.Context, filter filters.Args) (types.PluginsListResponse, error) {
...
func (_m *DockerRegistryAPI) PluginPush(ctx context.Context, name string, registryAuth string) (io.ReadCloser, error) {
...
func (_m *DockerRegistryAPI) PluginRemove(ctx context.Context, name string, options types.PluginRemoveOptions) error {
	ret := _m.Called(ctx, name, options)
...
func (_m *DockerRegistryAPI) PluginSet(ctx context.Context, name string, args []string) error {
...
func (_m *DockerRegistryAPI) PluginUpgrade(ctx context.Context, name string, options types.PluginInstallOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, name, options)
...
func (_m *DockerRegistryAPI) RegistryLogin(ctx context.Context, auth registry.AuthConfig) (registry.AuthenticateOKBody, error) {
...
func (_m *DockerRegistryAPI) SecretCreate(ctx context.Context, secret swarm.SecretSpec) (swarm.SecretCreateResponse, error) {
...
func (_m *DockerRegistryAPI) SecretInspectWithRaw(ctx context.Context, name string) (swarm.Secret, []byte, error) {
	ret := _m.Called(ctx, name)
...
func (_m *DockerRegistryAPI) SecretList(ctx context.Context, options swarm.SecretListOptions) ([]swarm.Secret, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerRegistryAPI) SecretRemove(ctx context.Context, id string) error {
	ret := _m.Called(ctx, id)
...
func (_m *DockerRegistryAPI) SecretUpdate(ctx context.Context, id string, version swarm.Version, secret swarm.SecretSpec) error {
...
func (_m *DockerRegistryAPI) ServerVersion(ctx context.Context) (types.Version, error) {
	ret := _m.Called(ctx)
...
func (_m *DockerRegistryAPI) ServiceCreate(ctx context.Context, service swarm.ServiceSpec, options swarm.ServiceCreateOptions) (swarm.ServiceCreateResponse, error) {
...
func (_m *DockerRegistryAPI) ServiceInspectWithRaw(ctx context.Context, serviceID string, options swarm.ServiceInspectOptions) (swarm.Service, []byte, error) {
...
func (_m *DockerRegistryAPI) ServiceList(ctx context.Context, options swarm.ServiceListOptions) ([]swarm.Service, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerRegistryAPI) ServiceLogs(ctx context.Context, serviceID string, options container.LogsOptions) (io.ReadCloser, error) {
	ret := _m.Called(ctx, serviceID, options)
...
func (_m *DockerRegistryAPI) ServiceRemove(ctx context.Context, serviceID string) error {
...
func (_m *DockerRegistryAPI) ServiceUpdate(ctx context.Context, serviceID string, version swarm.Version, service swarm.ServiceSpec, options swarm.ServiceUpdateOptions) (swarm.ServiceUpdateResponse, error) {
...
func (_m *DockerRegistryAPI) SwarmGetUnlockKey(ctx context.Context) (swarm.UnlockKeyResponse, error) {
	ret := _m.Called(ctx)
...
func (_m *DockerRegistryAPI) SwarmInit(ctx context.Context, req swarm.InitRequest) (string, error) {
...
func (_m *DockerRegistryAPI) SwarmInspect(ctx context.Context) (swarm.Swarm, error) {
	ret := _m.Called(ctx)
...
func (_m *DockerRegistryAPI) SwarmJoin(ctx context.Context, req swarm.JoinRequest) error {
	ret := _m.Called(ctx, req)
...
func (_m *DockerRegistryAPI) SwarmLeave(ctx context.Context, force bool) error {
...
func (_m *DockerRegistryAPI) SwarmUnlock(ctx context.Context, req swarm.UnlockRequest) error {
	ret := _m.Called(ctx, req)
...
func (_m *DockerRegistryAPI) SwarmUpdate(ctx context.Context, version swarm.Version, _a2 swarm.Spec, flags swarm.UpdateFlags) error {
...
func (_m *DockerRegistryAPI) TaskInspectWithRaw(ctx context.Context, taskID string) (swarm.Task, []byte, error) {
...
func (_m *DockerRegistryAPI) TaskList(ctx context.Context, options swarm.TaskListOptions) ([]swarm.Task, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerRegistryAPI) TaskLogs(ctx context.Context, taskID string, options container.LogsOptions) (io.ReadCloser, error) {
...
func (_m *DockerRegistryAPI) VolumeCreate(ctx context.Context, options volume.CreateOptions) (volume.Volume, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerRegistryAPI) VolumeInspect(ctx context.Context, volumeID string) (volume.Volume, error) {
...
func (_m *DockerRegistryAPI) VolumeInspectWithRaw(ctx context.Context, volumeID string) (volume.Volume, []byte, error) {
	ret := _m.Called(ctx, volumeID)
...
func (_m *DockerRegistryAPI) VolumeList(ctx context.Context, options volume.ListOptions) (volume.ListResponse, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerRegistryAPI) VolumeRemove(ctx context.Context, volumeID string, force bool) error {
...
func (_m *DockerRegistryAPI) VolumeUpdate(ctx context.Context, volumeID string, version swarm.Version, options volume.UpdateOptions) error {
...
func (_m *DockerRegistryAPI) VolumesPrune(ctx context.Context, pruneFilter filters.Args) (volume.PruneReport, error) {
	ret := _m.Called(ctx, pruneFilter)
...
// NewDockerRegistryAPI creates a new instance of DockerRegistryAPI. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewDockerRegistryAPI(t interface {
	mock.TestingT
	Cleanup(func())
}) *DockerRegistryAPI {
	mock := &DockerRegistryAPI{}
	mock.Mock.Test(t)
