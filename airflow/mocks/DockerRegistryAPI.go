...
func (_m *DockerRegistryAPI) ContainerCommit(ctx context.Context, _a1 string, options container.CommitOptions) (types.IDResponse, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) ContainerExecCreate(ctx context.Context, _a1 string, options container.ExecOptions) (types.IDResponse, error) {
	ret := _m.Called(ctx, _a1, options)
...
func (_m *DockerRegistryAPI) ContainerList(ctx context.Context, options container.ListOptions) ([]types.Container, error) {
	ret := _m.Called(ctx, options)
...
func (_m *DockerRegistryAPI) ImageLoad(ctx context.Context, input io.Reader, quiet bool) (image.LoadResponse, error) {
...
func (_m *DockerRegistryAPI) ServiceCreate(ctx context.Context, service swarm.ServiceSpec, options types.ServiceCreateOptions) (swarm.ServiceCreateResponse, error) {
...
func (_m *DockerRegistryAPI) ServiceUpdate(ctx context.Context, serviceID string, version swarm.Version, service swarm.ServiceSpec, options types.ServiceUpdateOptions) (swarm.ServiceUpdateResponse, error) {
